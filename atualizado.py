...
with abas[2]:
    ...
    if not dados_produtos.empty:
        st.success("Planilha de produtos carregada com sucesso.")
        dados_produtos = dados_produtos[['Produto', 'Produto Fornecedor', 'Preco Venda', 'Descricao', 'Codigo Getin', 'Saldo', 'Multiplo', 'Fator Conversao', 'Data Ult. Compra', 'NCM', 'CEST', '%MVA S', '% IPI']]
